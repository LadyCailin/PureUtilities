package com.methodscript.PureUtilities.Common.Annotations;
 ...
 * which we need to support. Instead, we have a real class that extends the interface and uses this
